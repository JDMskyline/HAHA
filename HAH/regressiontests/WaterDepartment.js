...
let departmentName = "Water_Revenue_Bureau";
...
//describe block
describe("TRB | Water Department Tax Category - Test Started", function () {
  //it block

  it("Water Department - Test Automation", async function () {
    //non-headless----------------------------------------------------
    /*
...
*/
    ...
    switch (taxCategory) {
      ...
      case "Water_Department":
        await driver
          .findElement(
            By.xpath("(//option[contains(text(),'Water department')])[1]")
          )
          .click();
        break;
    ...
    switch (taxType) {
      ...
      case "Water_department":
        await driver
          .findElement(
            By.xpath(
              "(//select/option[normalize-space()='Water department'])[2]"
            )
          )
          .click();
        break;
