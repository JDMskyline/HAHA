...
// mail | email
let preferredCorrespondence = "email";
...
//describe block
describe("TRB | Airport Tax Category - Test Started", function () {
  //it block

  it("Airport - Test Ran Successfully", async function () {
    //non-headless----------------------------------------------------
   ...
   /* let driver = await new Builder().forBrowser(browserSelect).build();
    ...
    const filePath = path.resolve(__dirname, 'helpers', 'Testfile.pdf');
