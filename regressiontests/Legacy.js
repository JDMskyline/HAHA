...
//describe block
describe("TRB | Legacy Tax Category - Test Started", function () {
  //it block
  ...
  it("Legacy - Test Automation", async function () {
    ...
    switch (taxCategory) {
      ...
      case "Legacy":
        await driver
          .findElement(
            By.xpath("(//select/option[normalize-space()='Legacy'])[1]")
          )
          .click();
        break;
    }
    ...
    switch (taxType) {
      ...
      case "Legacy":
        await driver
          .findElement(
            By.xpath("(//select/option[normalize-space()='Legacy'])[2]")
          )
          .click();
        break;
    }
    ...
    switch (departmentName) {
      ...
      case "Legacy":
        await driver
          .findElement(
            By.xpath("(//select/option[normalize-space()='Legacy'])[3]")
          )
          .click();
        break;
    }
