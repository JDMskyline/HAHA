...
let taxCategory = "Water_revenue";
//-------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------
//--> Water_revenue: Shut_off | TAP | Water_revenue | Occupancy_dispute
let taxType = "Occupancy_dispute";
//-------------------------------------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------
...
//describe block
describe("TRB | Water Revenue Tax Category - Test Started", function () {
  //it block

  it("Water Revenue - Test Automation", async function () {
    //non-headless----------------------------------------------------
