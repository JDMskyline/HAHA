...
let taxCategory = "Licenses_and_inspections";
...
let effectiveDate = "10/10/2022";
//Licenses_and_inspections | Revenue | Airport | PPA | PWD | Water_Revenue_Bureau
let departmentName = "PPA";
let accNumber = config.AD_ACCNUMBER;
let initialBillDate = "03/01/2022";
let disputedPeriodStart = "August 2010";
let disputedPeriodEnd = "December 2022";
let principalamt = 89000;
let interestamt = 16000;
let penaltyamt = 7300;
...
let caseDecision = "Save_as_nunc_pro_tunc";
...
//describe block
describe("TRB | Nunc Pro Tunc Test Started", function () {
  //it block

  it("Nunc Pro Tunc - Test Automation", async function () {
    //non-headless----------------------------------------------------
    /*
